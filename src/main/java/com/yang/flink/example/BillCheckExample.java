...
public class BillCheckExample {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple4<String, String, String, Long>> thirdPartStream = env.fromElements(
                ...
                Tuple4.of("order-3", "third-party", "success", 6000L)
                ...
                .withTimestampAssigner(
                        (SerializableTimestampAssigner<Tuple4<String, String, String, Long>>)
                                (element, recordTimestamp) -> element.f3)
        );
    ...
    public static class OrderMatchResult extends CoProcessFunction<
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            thirdPartyEventState = getRuntimeContext().getState(
                    new ValueStateDescriptor<>("thirdPartStream-event", Types.TUPLE(Types.STRING, Types.STRING,
